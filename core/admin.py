...
class HistoryAdmin(admin.ModelAdmin):
    ...
    list_filter = (("date", DateRangeFilter), "status", "type")

    def formatted_date(self, obj):
        return obj.date.strftime("%d.%m.%Y")  # день.месяц.год часы:минуты
    ...
    formfield_overrides = {
        models.DateField: {
            ...
            "input_formats": ["%d.%m.%Y"],  # тут Django поймёт этот формат
        },
    }
